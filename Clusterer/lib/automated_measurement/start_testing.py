...
def start_react_dev_env():
    command = shlex.split('python3 app.py --port 4546 --redis 6380')
...
def start_system_load():
    ...
    Popen(command, cwd='/Users/base/MEGA/Universität/Tez/DataWiz/Clusterer/lib/automated_measurement/System Load')
...
if __name__ == "__main__":
    ...
    p3 = Process(target=start_system_load)
